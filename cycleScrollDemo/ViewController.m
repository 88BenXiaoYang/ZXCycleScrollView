...
- (void)viewDidLoad {
    [super viewDidLoad];
    _scrollView = [ZXCycleScrollView  initWithFrame:CGRectMake(0, 100, KScreenWidth, 200) withMargnPadding:10 withImgWidth:KScreenWidth - 40 dataArray:@[@"http://d.hiphotos.baidu.com/image/pic/item/b7fd5266d016092408d4a5d1dd0735fae7cd3402.jpg"]] ;
